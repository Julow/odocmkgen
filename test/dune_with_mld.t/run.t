...
Use paths found by findlib:
  ...
  'odoc' 'compile' '-c' 'Test' '$TESTCASE_ROOT/_build/install/default/doc/test/odoc-pages/test.mld' '-o' 'odocs/test/odoc-pages/page-test.odoc'
  'odoc' 'compile' '--parent' 'page-test' '$TESTCASE_ROOT/_build/install/default/lib/test/test.cmti' '-I' 'odocs/test/odoc-pages/' '-o' 'odocs/test/test.odoc'
